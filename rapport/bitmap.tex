...
\begin{figure}[H]
    \centering
    \subcaptionbox{Bitmap source}{\includegraphics[width=0.45\textwidth]{splash_color_src.eps}}%
    \hfill
    \subcaptionbox{Bitmap dest }{\includegraphics[width=0.45\textwidth]{splash_color_dest.eps}}%
